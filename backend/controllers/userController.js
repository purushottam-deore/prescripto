...
const registerUser = async (req, res) => {
    ...
    try {
        ...
        if (!name || !email || !password) {
            return res.json({ success: false, message: "Missing Deatiled" })
        }
...
const updateProfile = async (req, res) => {
    try {
        ...
        const userId = req.userId; // must come from middleware
...
// API to get user appointments for fronted my-appointment page
