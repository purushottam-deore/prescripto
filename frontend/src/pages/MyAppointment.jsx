      ...
      <div>
        {appointments.map((item, index) => (
          <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b' key={index}>
            <div>
              <img className='w-32 text-sm bg-indigo-50' src={item.docData.image} alt="" />
            </div>
            ...
            <div className='flex flex-col gap-2 justify-end'>
              ...
              {item.cancelled && !item.isCompleted && <button className='sm:min-w-48 py-2 border border-red-500 text-red-500'>Appointmnent Cancelled</button>}
