...
const TopDocters = () => {
    ...
    return (
        <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10'>
            <h1 className='text-3xl font-center text-medium'>Top Docters to Book</h1>
            <p>Simply browse through our extensive list of trusted doctors</p>

            {loading ? (
                <div className="flex flex-col items-center justify-center py-20 space-y-4 w-full">
                    <div className="w-12 h-12 border-4 border-blue-200 border-t-blue-600 rounded-full animate-spin"></div>
                    <p className="text-gray-500 font-medium animate-pulse text-sm">Waking up server, please wait...</p>
                </div>
            ) : (
